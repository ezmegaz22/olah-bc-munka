          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-5">
            ...
            <main>
              ...
              <div className="flex flex-wrap items-center space-x-2 mb-2">
                ...
                <span className="text-green-500">Ellenőrzött</span>
              </div>
              ...
              <ul className="mb-5">
                <li className="mb-1">
                  {" "}
                  <b className="font-medium w-36 inline-block">Készlet</b>
                  {inStock ? (
                ...
                <li className="mb-1">
                  {" "}
                  <b className="font-medium w-36 inline-block">Kategória:</b>
